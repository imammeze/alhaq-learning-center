  ...
  return (
    <div className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#program"
              className="text-sm font-medium text-gray-600 hover:text-rose-900 transition-colors">
              Program Kami
            </a>
            <a
              href="#tentang"
            ...
            <Link
              href="/login"
              className="px-5 py-2.5 bg-rose-900 text-white text-sm font-bold rounded-xl hover:bg-rose-950 transition-colors">
              Masuk
            </Link>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden pt-32 pb-16 lg:pt-40 lg:pb-24">
        ...
        <div className="absolute top-0 right-0 w-125 h-125 bg-rose-100 rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-125 h-125 bg-red-100 rounded-full blur-3xl opacity-50 translate-y-1/3 -translate-x-1/3" />
        ...
        <div className="max-w-6xl mx-auto px-5 lg:px-6 relative z-10 text-center">
          ...
          <h1 className="text-4xl lg:text-7xl font-bold text-gray-900 leading-tight mb-6 max-w-4xl mx-auto">
            ...
            <span className="text-rose-800">Cerdas & Berakhlak Mulia</span>
          </h1>

          <p className="text-lg lg:text-xl text-gray-500 leading-relaxed mb-10 max-w-2xl mx-auto">
            Pusat bimbingan belajar berkualitas mulai dari usia dini hingga
            dewasa. Kami memadukan pendidikan umum dengan nilai-nilai spiritual
            Islam yang kuat.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Berbagai pilihan program edukasi unggulan yang disesuaikan dengan
              kelompok usia dan kebutuhan pembelajaran Anda.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* Card 1: Alhaq Kids */}
            <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all group flex flex-col h-full">
              ...
              <p className="text-blue-600 font-semibold text-sm mb-4">
                TK & SD Kelas Awal (4-12 Tahun)
              </p>
              <p className="text-gray-500 leading-relaxed mb-8 grow">
                Bimbingan belajar mengaji yang menyenangkan dan interaktif untuk
                anak. Memperkenalkan Al-Quran dengan penuh kasih sayang.
              </p>
            ...
            {/* Card 2: Rumah Quran */}
            <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-xl shadow-emerald-900/5 hover:shadow-2xl hover:shadow-emerald-900/10 transition-all group flex flex-col h-full md:-translate-y-4">
              <div className="absolute top-0 right-0 px-4 py-1.5 bg-emerald-500 text-white text-xs font-bold rounded-bl-2xl rounded-tr-4xl">
                POPULER
              </div>
      ...
      <section id="tentang" className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-5 lg:px-6">
          <div className="bg-rose-950 rounded-[3rem] p-8 lg:p-16 text-white overflow-hidden relative">
            <div className="absolute top-0 right-0 w-125 h-125 bg-white/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="relative z-10 lg:flex lg:items-center gap-16">
              <div className="lg:w-1/2 mb-10 lg:mb-0">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    {
                      icon: UsersIcon,
                      text: "Fasilitator dan Tutor Profesional",
                    },
                    {
                      icon: HeartIcon,
                      text: "Lingkungan Belajar yang Islami & Nyaman",
                    },
                    {
                      icon: BuildingIcon,
                      text: "Fasilitas Belajar Berbasis Masjid Terpadu",
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
              ...
              <div className="lg:w-1/2 relative">
                ...
                <div className="aspect-4/5 bg-rose-500/20 rounded-4xl border border-white/10 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
      ...
      <footer
        id="hubungi"
        className="bg-slate-50 pt-16 pb-8 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-5 lg:px-6">
          ...
          <div className="text-center pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Yayasan Masjid Al Haq Bata Merah
              Purwokerto. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] pb-safe">
        <div className="flex items-center justify-around px-2 py-2">
          <a
            href="#"
            className="flex flex-col items-center gap-1 py-1.5 px-3 text-rose-900 transition-colors">
            <HomeIcon className="w-5 h-5" />
            <span className="text-[10px] font-medium">Beranda</span>
          </a>
          <a
            href="#program"
            className="flex flex-col items-center gap-1 py-1.5 px-3 text-gray-500 hover:text-rose-900 transition-colors">
