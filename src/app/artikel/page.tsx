...
export const metadata: Metadata = {
  title: 'Artikel & Pengumuman | Alhaq Learning Center',
  description: 'Kumpulan artikel, berita, dan pengumuman terbaru dari seluruh program di Alhaq Learning Center.',
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-5 lg:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-800 hidden sm:block">Alhaq Learning Center</span>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-16 bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-5 lg:px-6 text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            Temukan berbagai informasi terbaru, artikel edukasi, dan dokumentasi kegiatan dari seluruh program di Alhaq Learning Center.
          </p>
        </div>
      </section>
      ...
      <main className="py-16 max-w-6xl mx-auto px-5 lg:px-6">
        <ArticleList programCode="all" colorTheme="blue" />
      </main>
