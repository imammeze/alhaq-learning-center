...
export const metadata: Metadata = {
  title: 'Artikel & Berita | Prestasi Ceria Academy',
  description: 'Kumpulan artikel, berita, dan informasi terbaru dari Prestasi Ceria Academy.',
};

export default function PrestasiCeriaArticlePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-5 lg:px-6 py-4 flex items-center justify-between">
          <Link 
            href="/prestasi-ceria" 
            className="inline-flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-amber-600 transition-colors"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-800 hidden sm:block">Prestasi Ceria Academy</span>
          </div>
        </div>
      </nav>
