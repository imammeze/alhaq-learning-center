...
export const metadata: Metadata = {
  title: 'Artikel & Berita | Alhaq Kids Center',
  description: 'Kumpulan artikel, berita, dan informasi terbaru dari Alhaq Kids Center.',
};

export default function AlhaqKidsArticlePage() {
  return (
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-5 lg:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-800 hidden sm:block">Alhaq Kids Center</span>
          </div>
        </div>
      </nav>
